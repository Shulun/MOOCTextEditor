...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		list1.add(20);
		assertEquals("Add: check element 20 is added ", (Integer)20, list1.get(3));
	...
	{
		// TODO: implement this test
		assertEquals("Add: check size is correct ", 0, emptyList.size());
	...
	public void testSet()
	{
		...
		int a = longerList.set(2, 10);
		assertEquals("Set: check value is correct ", (Integer)10, longerList.get(2));
		assertEquals("Set: check size is correct", 10, longerList.size());
		assertEquals("Set: check replaced value is correct", 2, a);
		
		String b = shortList.set(1, "C");
		assertEquals("Set: check value is correct ", (String)"C", shortList.get(1));
		assertEquals("Set: check size is correct", 2, shortList.size());
		assertEquals("Set: check replaced value is correct", "B", b);
	}
