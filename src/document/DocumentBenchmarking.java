...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		System.out.print("Basic Document" + "\t\t");
		System.out.print("Efficient Document" + "\n");
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 float basicTime = measureTime(trials, () -> new BasicDocument(text));
			 System.out.print(basicTime + "\t\t");
			 float efficientTime = measureTime(trials, () -> new EfficientDocument(text));
			 ...
			 float ElapsedTime = (endTime - startTime)/100000000f;
			 ...
			 ElapsedTime = (endTime - startTime)/100000000f;
			 System.out.print(ElapsedTime + "\n");
			 */
		}
	...
	private static float measureTime(int trials, Supplier<Document> doc) {
